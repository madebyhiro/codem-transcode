...
function validateJobRequest(postData, callback) {
  ...
  try {
    ...
    var acceptedFields = ['source_file', 'destination_file', 'encoder_options', 'thumbnail_options', 'segments_options', 'callback_urls', 'label'];
...
function spawnJob(opts, callback) {
  Job.create(
    opts,
