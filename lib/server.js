...
// POST /probe
function probeFile(request, response) {
  var postData = "";
...
// POST /jobs
function postNewJob(request, response) {
  var postData = "";
...
// GET /jobs/:id
function getJobStatus(request, response) {
...
// DELETE /jobs/purge
function purgeJobs(request, response) {
...
function rejectRequestDueToLogger(response) {
  var body = {};
...
function processPostedJob(postData, response) {
  response.setHeader('Content-Type', 'application/json; charset=utf-8');
...
function processProbe(postData, response) {
  response.setHeader('Content-Type', 'application/json; charset=utf-8');
  var body = {};
