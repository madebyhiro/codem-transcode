...
var getJobs,postNewJob,getJobStatus,removeJob,processPostedJob;
...
exports.launch = function () {
	logfile = fs.createWriteStream(config['access_log'], {
		flags: 'a'
	});
...
postNewJob = function (request, response) {
	...
	request.on('end', function () {
		processPostedJob(postData, response);
	});
};
...
getJobs = function (request, response) {
	var content = {
		...
		free_slots: jobHandler.freeSlots(),
		jobs: jobHandler.slots,
		queue: jobHandler.queue
	};
